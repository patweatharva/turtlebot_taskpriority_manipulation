...
class OdomData:
    ...
    def update_encoder_reading(self, odom, timestamp):
        """
        ...
        if self.mode == "SIL":
            ...
            if self.leftEncoder.tag in odom.name:
                ...
                self.leftEncoder.stamp      = timestamp 
            # Check if encoder data is for the right wheel
                ...
                self.rightEncoder.stamp     = timestamp 
        elif self.mode == "HIL":
    ...
    def read_encoder(self, odom, timestamp):
        """
        ...
        """
        self.update_encoder_reading(odom, timestamp)
